...
<html>
  <head>
    ...
    />
    <title>Kop Chai Jerky - Black Bomb</title>
                    ...
                    <div class="detail-box">
                      <div class="detail-box-body">
                        ...
                        <div class="detail-box-text">
                          <p>
                            Marinaded in a special blend of soy sauces, Black Bomb is our most umami filled jerky! The flavor profile is hard to pinpoint but will be sure to delight!
                          </p>
                        </div>
                        ...
                        <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>?action=addcart">
                          ...
                          <input type="hidden" name="sku" value="blackbomb">
                      </form>
                        ...
                        <form action = "https://www.sandbox.paypal.com/us/cgi-bin/webscr" method = "post" target = "paypal">
                          ...
                          <input type = "hidden" name = "item_name" value = "Black Bomb" />
