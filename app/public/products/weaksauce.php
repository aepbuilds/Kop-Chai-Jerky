...
<html>
  <head>
    ...
    />
    <title>Kop Chai Jerky - Weaksauce</title>
                    ...
                    <div class="detail-box">
                      <div class="detail-box-body">
                        ...
                        <div class="detail-box-text">
                          <p>
                            Full of flavor without the heat. Weaksauce is made for those who want their jerky hot, but not too hot.
                          </p>
                        </div>
                        ...
                        <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>?action=addcart">
                          ...
                          <input type="hidden" name="sku" value="weaksauce">
                      </form>
                        ...
                        <form action = "https://www.sandbox.paypal.com/us/cgi-bin/webscr" method = "post" target = "paypal">
                          ...
                          <input type = "hidden" name = "item_name" value = "Weaksauce" />
